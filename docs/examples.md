...
This guide provides practical examples of using brosh's CLI and MCP tools for various tasks. These examples show the MCP tool calls that AI assistants like Claude Code use to interact with the terminal.
