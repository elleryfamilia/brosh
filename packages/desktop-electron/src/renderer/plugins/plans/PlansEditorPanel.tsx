/**
 * PlansEditorPanel — Tiptap markdown editor for plan files
 *
 * Reuses the same TiptapEditor as the docs plugin for WYSIWYG markdown editing.
 */

import { useState, useEffect, useCallback, useRef } from 'react';
import type { EditorPanelProps } from '../types';
import { TiptapEditor } from '../docs/TiptapEditor';

export function PlansEditorPanel({ filePath, onClose }: EditorPanelProps) {
